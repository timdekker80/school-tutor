...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 22 jun 2025 om 18:32
...
INSERT INTO `announcement` (`id`, `user_id`, `text`, `role`) VALUES
(1, 4, 'dknfdihf', '\"ROLE_STUDENT\"');
...
('DoctrineMigrations\\Version20250521102109', '2025-05-21 12:21:22', 142);
...
(2, 8, 'hoodspijn', '2025-05-20 23:32:00'),
(3, 7, 'gfgd', '2007-03-31 05:45:00');
...
(8, 'mahmut@gmail.com', '[\"ROLE_EMPLOYEE\"]', '$2y$13$dbjGzkaMSzQfLB/qJ2t6xui5l5kMw3LzIo3zL/ZWIr0V38OKMPkyu'),
(10, 'student3@gmail.com', '[\"ROLE_TEACHER\"]', '$2y$13$LBT0FmcqWtgoFlCAT/h7l.pIkVHMG/7ufCkW.jHYicu/MFVU2QNG.'),
(11, 'student4@gmail.com', '[\"ROLE_STUDENT\"]', '$2y$13$q6bBtxCVpdSrfPxruY8gReUacTF7mm4qgxvsTrxG5madnZU9OjOk2');
